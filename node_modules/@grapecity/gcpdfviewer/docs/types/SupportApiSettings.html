<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>SupportApiSettings | Document Solutions PDF Viewer - v7.1.0</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.1.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li class="tsd-parameter">
<h5>implementation<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ISupportApiBase</span></h5>
<div class="tsd-comment tsd-typography"><p>Specifies a custom implementation of the SupportApi for editing functions. 
When this property is set, the viewer will use the provided custom implementation instead of a separate service. 
All other properties (apiUrl, webSocketUrl, and token) will be ignored.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Example</span><br/><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#root&quot;</span><span class="hl-1">, {</span><br/><span class="hl-1">     </span><span class="hl-2">supportApi:</span><span class="hl-1"> {</span><br/><span class="hl-1">       </span><span class="hl-2">implementation:</span><span class="hl-1"> </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">CustomSupportApi</span><span class="hl-1">()</span><br/><span class="hl-1">     }</span><br/><span class="hl-1">});</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
