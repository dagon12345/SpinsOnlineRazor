<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>ReplyToolSettings | Document Solutions PDF Viewer - v7.1.0</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.1.0"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<div class="tsd-comment tsd-typography"><p>Allow adding notes.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allow adding replies.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allow adding replies to other user notes.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allow changing other user notes.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allow changing user name.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allow deleting notes/replies.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allow deleting other user notes.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allow setting status.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>Allow setting status for other user notes.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> annotation<wbr/>Focus<wbr/>Color<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>The color property that determines the color used for temporary highlighting
of an annotation on the PDF page when the annotation is selected in the
comments list in the ReplyTool.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">GcPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#root&quot;</span><span class="hl-1">, { </span><span class="hl-2">replyTool:</span><span class="hl-1"> { </span><span class="hl-2">annotationFocusColor:</span><span class="hl-1"> </span><span class="hl-4">&quot;blue&quot;</span><span class="hl-1"> } });</span>
</code></pre>

<h3>Property</h3><p>The color in hex format for the temporary highlight.
  This setting is also utilized in the <code>showAnnotationFocusOutline</code> method when
  the color parameter is not explicitly specified.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> auto<wbr/>Expand<wbr/>On<wbr/>Comment<wbr/>Add<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>Controls whether the Reply Tool automatically expands when a comment is added via the context menu.</p>

<h3>Property</h3><p>Set to <code>true</code> to enable automatic expansion,
  or <code>false</code> to disable it.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Disable automatic expansion of the Reply Tool.</span><br/><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">GcPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#root&quot;</span><span class="hl-1">, { </span><span class="hl-2">replyTool:</span><span class="hl-1"> { </span><span class="hl-2">autoExpandOnCommentAdd:</span><span class="hl-1"> </span><span class="hl-0">false</span><span class="hl-1"> } });</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
...
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> use<wbr/>Colored<wbr/>Icons<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>If set to true, comment icons will be filled with the color used in the annotation.</p>
</div></li></ul></div></div>
