...
export declare class ReplyTool extends Component<ReplyToolProps, ReplyToolModel> {
    ...
    initialize(): void;
    uninitialize(): void;
    scrollItemContentIntoView(annotationId: string | HTMLElement): void;
    ...
    onAuthorLabelClick: (pageIndex: number, node: TextAnnotation, isSelected: boolean) => () => void;
    ...
    selectItemInternal(pageIndex: number, node: AnnotationBase): void;
    unselectItemInternal(pageIndex: number, node: AnnotationBase): void;
    _onPageButtonClick(pageIndex: number): void;
    _onReplyPlaceholderClick(pageIndex: number, node: AnnotationBase): boolean;
    _onCancelReplyClick(): boolean;
    _onPostReplyClick(pageIndex: number, node: TextAnnotation): boolean;
    _onItemKeyDown(event: KeyboardEvent<any>, pageIndex: number, node: AnnotationBase): Promise<void>;
    ...
    execDeleteAction(pageIndex: number, node: AnnotationBase): Promise<void>;
