...
<head>
    ...
    <title>GrapeCity Documents PDF Viewer Localization Demo</title>
    <script>
        // Here's example how to fetch localization strings
        // (Note, you need to run the page on a web server for the fetch to work.)
        /*
        async function fetchLocalizationStrings() {
            try {
                const response1 = await fetch("en-viewer-base.json");
                const response2 = await fetch("en-pdf-viewer.json");
        ...
        const translationJson = await fetchLocalizationStrings();
        */
        ...
        function loadPdfViewer(selector) {
            ...
            GcPdfViewer.i18n.init({
                ...
                const viewer = new GcPdfViewer(selector, options);
                viewer.addDefaultPanels();
                
                // Uncomment the next line to open a PDF file
                // viewer.open("sample.pdf");
            });
            
        }
    </script>
    <script defer="defer" src="../gcpdfviewer.js"></script>
</head>
